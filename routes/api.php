...
Route::post('/operational/rts-script/sync/{machine_number}',['App\Api\Controllers\Operational\RtsScriptController','sync']);
...
Route::group(['middleware'=>['auth:sanctum','auth.user.mode']],function(){
    ...
    Route::prefix('/operational')->group(function (){
        ...
        Route::get('/light/{machine_number}',['App\Api\Controllers\Operational\LightController','index']);
        ...
        Route::get('/training/pdf/{id}',['App\Api\Controllers\Operational\TrainingController','pdf']);
        Route::get('/training/latest/{machine_number}',['App\Api\Controllers\Operational\TrainingController','latestTime']);
